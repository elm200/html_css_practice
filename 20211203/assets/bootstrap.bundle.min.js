...
!(function (t, e) {
      ...
      return (
        ...
        (r._keydown = function (t) {
          /input|textarea/i.test(t.target.tagName) ||
            ("ArrowLeft" === t.key
              ...
              : "ArrowRight" === t.key && (t.preventDefault(), this.next()));
        }),
        (r._getItemIndex = function (t) {
          return (
            (this._items =
              t && t.parentNode ? Y(".carousel-item", t.parentNode) : []),
        ...
        (r._setActiveIndicatorElement = function (t) {
          if (this._indicatorsElement) {
            for (
              var e = Y(".active", this._indicatorsElement), n = 0;
              n < e.length;
              n++
            )
  ...
  B.on(
    ...
    B.on(window, "load.bs.carousel.data-api", function () {
      for (
        var t = Y('[data-bs-ride="carousel"]'), e = 0, n = t.length;
        e < n;
        e++
      )
  ...
  var G = { toggle: !0, parent: "" },
    ...
    J = (function (t) {
      function o(e, n) {
        ...
        for (
          var o = Y('[data-bs-toggle="collapse"]'), r = 0, s = o.length;
          r < s;
          r++
        ) {
          var a = o[r],
      ...
      return (
        ...
        (r.show = function () {
          ...
          if (
            ...
            this._parent &&
              0 ===
                (e = Y(".show, .collapsing", this._parent).filter(function (e) {
  ...
  function Dt(t) {
    ...
    if (l) {
      ...
      v === ct(n) && (v = _t(n)),
        o === tt &&
          ((g = et), (d -= v.clientHeight - i.height), (d *= a ? 1 : -1)),
        o === it &&
          ((p = nt), (u -= v.clientWidth - i.width), (u *= a ? 1 : -1));
    }
    var _,
        ...
        (("body" !== lt(e) || Rt(r)) &&
          (l =
            (i = e) !== ct(i) && dt(i)
              ...
              : Bt(i)),
        dt(e)
          ? (((c = It(e)).x += e.clientLeft), (c.y += e.clientTop))
          : r && (c.x = Ht(r))),
      {
  ...
  var oe = ie(),
    re = ie({ defaultModifiers: [St, Zt, xt, ft] }),
    se = ie({ defaultModifiers: [St, Zt, xt, ft, Gt, Vt, Jt, At, $t] }),
    ae = Object.freeze({
      __proto__: null,
      popperGenerator: ie,
      detectOverflow: qt,
      ...
      return (
        ...
        (o.clearMenus = function (t) {
          if (!t || (2 !== t.button && ("keyup" !== t.type || "Tab" === t.key)))
            for (
              var e = Y('[data-bs-toggle="dropdown"]'), n = 0, i = e.length;
              n < i;
              n++
            ) {
      ...
      return (
        ...
        (r._setScrollbar = function () {
          ...
          if (this._isBodyOverflowing) {
            Y(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach(
              function (e) {
          ...
          l.forEach(function (t) {
            (function (t, e) {
              ...
              if (e.includes(n))
                return (
                  !we.has(n) ||
                  Boolean(t.nodeValue.match(Ee) || t.nodeValue.match(Te))
                );
              for (
      ...
      (o._transitionComplete = function (t, e, n) {
        ...
        t.classList.add("active"),
          ...
          t.parentNode &&
            ...
            (t.closest(".dropdown") &&
              Y(".dropdown-toggle").forEach(function (t) {
                return t.classList.add("active");
              }),
            t.setAttribute("aria-expanded", !0)),
          n && n();
  ...
  var Ke = { animation: "boolean", autohide: "boolean", delay: "number" },
    Fe = { animation: !0, autohide: !0, delay: 5e3 },
    Ue = (function (t) {
      function o(e, n) {
        var i;
        return (
